...
using BaiTap1_61133539.Models;

namespace BaiTap1_61133539.Controllers
{
    public class PhepToan_61133539Controller : Controller
    {
        ...
        public ActionResult UseRequest(string pt)
        {
            ...
            switch (pt)
            {
                ...
                case "*": ViewBag.KQ = a * b; break;
                case "/":
                    if (b == 0) ViewBag.KQ = "Không chia được cho 0 nha ";
        ...
        {
            double a = Convert.ToDouble(f["a"]);
            double b = Convert.ToDouble(f["b"]);
        ...
        public ActionResult UseModels()
        {
            return View();
        }
        [HttpPost]
        public ActionResult UseModels(CalModels cal)
        {
            switch (cal.pt)
            {
                ...
                case "*": ViewBag.KQ = cal.a * cal.b; break;
                case "/":
                    if (cal.b == 0) ViewBag.KQ = "Không chia được cho 0 nha ";
